...
class Hesap extends JFrame implements ActionListener { 
    ...
    JButton btn_clr = new JButton("Temizle");
    ...
    public Hesap() {
        ...
        JFrame frmHesapMakinas = new JFrame("SIMPLE JAVA CALCULATOR");
        frmHesapMakinas.setIconImage(Toolkit.getDefaultToolkit().getImage(Hesap.class.getResource("/Ekran/calc2.png")));
        frmHesapMakinas.setTitle("Hesap Makinas\u0131");
        frmHesapMakinas.setSize(320,320);
        frmHesapMakinas.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        frmHesapMakinas.setResizable(false);
        frmHesapMakinas.setVisible(true);
        
        frmHesapMakinas.getContentPane().setLayout(new BorderLayout());
        ...
        LabelPanel.add(new JLabel("SONU\u00C7"));
        LabelPanel.add(txt);
        ...
        frmHesapMakinas.getContentPane().add(NumberPanel,BorderLayout.CENTER);
        frmHesapMakinas.getContentPane().add(LabelPanel,BorderLayout.SOUTH);
